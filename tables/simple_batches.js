/**
 * simple_batches Table DDL:
 * BEGIN_DDL
CREATE TABLE simple_batches (
    id INTEGER NOT NULL,
    ...
    description TEXT,
    PRIMARY KEY (id),
    CONSTRAINT simple_batches_batch_id_unique UNIQUE (batch_id)
);
 * END_DDL
 */
...
class SimpleBatches extends Model {
